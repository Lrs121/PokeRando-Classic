...
public class MainActivityOld extends AppCompatActivity {
    ...
    private final ActivityPermissionRequest permissionRequest = new ActivityPermissionRequest.Builder(this)
            ...
            .withCallback(new PermissionCallback() {
                ...
                public void onShouldRedirectToSystemSettings(@NotNull List<PermissionReport> blockedPermissions) {
                    SimpleStorageHelper.redirectToSystemSettings(MainActivityOld.this);
                }
            })
            .build();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(MainActivityOld.this,
        ...
        storageHelper.setOnFileSelected((requestCode, files) -> {
            try {
                ...
                switch (e.getType()) {
                    case LENGTH:
                        ...
                        Toast.makeText(MainActivityOld.this, String.valueOf(R.string.rom_too_short), Toast.LENGTH_SHORT).show();
                        return null;
                    case ZIP_FILE:
                        Log.e(String.valueOf(R.string.invalid_rom), getString(R.string.zip_file_selected));
                        Toast.makeText(MainActivityOld.this, String.valueOf(R.string.zip_file_selected), Toast.LENGTH_SHORT).show();
                        return null;
                    case RAR_FILE:
                        Log.e(String.valueOf(R.string.invalid_rom), getString(R.string.rar_file_selected));
                        Toast.makeText(MainActivityOld.this, String.valueOf(R.string.rar_file_selected), Toast.LENGTH_SHORT).show();
                        return null;
                    case IPS_FILE:
                        Log.e(String.valueOf(R.string.invalid_rom), getString(R.string.ips_file_selected));
                        Toast.makeText(MainActivityOld.this, String.valueOf(R.string.ips_file_selected), Toast.LENGTH_SHORT).show();
                        return null;
                    case UNREADABLE:
                    default:
                        Log.e(String.valueOf(R.string.invalid_rom), getString(R.string.unknown_file));
                        Toast.makeText(MainActivityOld.this, R.string.unknown_file, Toast.LENGTH_SHORT).show();
                        e.printStackTrace();
                        return null;
                }
            }
            ...
            for (RomHandler.Factory factory : factories) {
                if (factory.isLoadable(DocumentFileUtils.getAbsolutePath(files.get(0), getApplicationContext()).toString().trim())) {
                    ...
                    Snackbar.make(MainActivityOld.this, findViewById(R.id.topLayout),
                            getString(R.string.unsupported_game), Snackbar.LENGTH_SHORT).show();
                }
            }
            Toast.makeText(MainActivityOld.this, DocumentFileUtils.getBaseName(files.get(0)),
